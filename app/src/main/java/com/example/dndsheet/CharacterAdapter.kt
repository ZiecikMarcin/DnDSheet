...
class CharacterAdapter (var mCtx:Context , var resource:Int,var items:List<Model>):ArrayAdapter<Model>( mCtx , resource , items ) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        imageView.setImageDrawable(mCtx.resources.getDrawable(person.photo, null))
